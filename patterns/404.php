...
<div class="wp-block-group entry-header has-secondary-color has-text-color has-background has-link-color" style="background-color:#d4d9df;margin-top:0;margin-bottom:0;padding-top:45px;padding-right:0;padding-bottom:45px;padding-left:0"><!-- wp:heading {"textAlign":"left","level":1} -->
<h1 class="wp-block-heading has-text-align-left"><?php echo esc_html__( 'Not found, error 404', 'compilation' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
