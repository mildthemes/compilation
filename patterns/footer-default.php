 ...
 * Categories: compilation-footers
 */
?>
<!-- wp:group {"align":"full","className":"has-background-color","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"spacing":{"padding":{"top":"40px","bottom":"40px","left":"30px","right":"30px"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"secondary","textColor":"base","fontSize":"small","layout":{"type":"constrained","contentSize":"960px"}} -->
...
<div class="wp-block-column" style="flex-basis:55%"><!-- wp:heading {"level":4,"className":"wp-block-heading","style":{"typography":{"lineHeight":"1"}},"fontSize":"medium"} -->
...
<!-- wp:column {"width":"23%"} -->
<div class="wp-block-column" style="flex-basis:23%"><!-- wp:heading {"level":4,"className":"wp-block-heading","style":{"typography":{"lineHeight":"1"}},"fontSize":"medium"} -->
...
<ul style="font-size:15px" class="wp-block-list"><!-- wp:list-item {"fontSize":"x-small"} -->
...
<!-- wp:column {"width":"15%"} -->
<div class="wp-block-column" style="flex-basis:15%"><!-- wp:heading {"level":4,"className":"wp-block-heading","style":{"typography":{"lineHeight":"1"}},"fontSize":"medium"} -->
<h4 class="wp-block-heading has-medium-font-size" id="connect" style="line-height:1"><?php echo esc_html__( 'Connect ¬', 'compilation' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:list {"style":{"typography":{"fontSize":"15px"}}} -->
<ul style="font-size:15px" class="wp-block-list"><!-- wp:list-item -->
